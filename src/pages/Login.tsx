      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6 shadow-xl">
          <div className="flex items-center gap-2.5 mb-6">
            ...
            <div>
              <h1 className="text-sm font-bold text-white">Sign In</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="••••••••" className="w-full text-sm bg-slate-800 border border-slate-700 rounded-lg px-3 py-2.5 pr-10 text-white placeholder-slate-500 focus:border-indigo-500 focus:outline-hidden" />
          ...
          <p className="mt-4 text-xs text-center text-slate-500">
            Don't have an account? <a href="/signup" className="text-indigo-400 hover:text-indigo-300 font-semibold">Sign up</a>
          </p>
        </div>
      </div>
    </div>
